...
const AddListing = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        `${import.meta.env.VITE_BACKEND_URL}/listings/add`,
            ...
            return (
              <>
                ...
                <Input
                  ...
                  onChange={updateImagesArr(index)}
                />
                <button
                  className="customBttn"
                  role="button"
                  onClick={decreaseImagesArr(index)}
                >
                  Delete Image
                </button>
              </>
